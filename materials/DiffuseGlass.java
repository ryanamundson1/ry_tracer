...
public class DiffuseGlass extends Material {
	...
	DiffuseGlass(Color diff, Color op, Color spec, double r, long i, double ks, double kd, double kr, double fa, double ir){
		diffuse = diff;
		opacity = op;
		specular = spec;
		kS= ks;
